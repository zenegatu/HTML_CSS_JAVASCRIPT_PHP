...
/*--------  Private (Internal) Functions -------- */
    ...
    function SendFormSubmission()
    {
        ...
        $this->mailer->Subject = "CV submission from $this->name";
        ...
        $this->mailer->AddReplyTo($this->email);
		 $this->mailer->Language = $this->nativeLang;
    ...
    */
    ...
    function ComposeFormtoEmail()
    {
        ...
        $message = $style."New CV submission :<p>$formsubmission</p><hr/>$extra_info";
    ...
    function Validate()
    {
        ...
        {
            $this->add_error("Please provide your native language");
            $ret = false;
        }
        else
        if(strlen($_POST['nativLang'])>50)
        {
            $this->add_error("native language is too big!");
            $ret = false;
        }
    ...
    */
    ...
    function CollectData()
    {
		...
		$this->nativeLang = $this->Sanitize($_POST['nativeLang']);
